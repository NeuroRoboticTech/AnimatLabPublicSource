...
Namespace Collections
    ...
    Public Class IonChannels
        ...
        Public Sub Add(ByVal key As [String], ByVal value As IntegrateFireGUI.DataObjects.Behavior.Neurons.IonChannel, Optional ByVal bCallSimMethods As Boolean = True, Optional ByVal bThrowError As Boolean = True)
