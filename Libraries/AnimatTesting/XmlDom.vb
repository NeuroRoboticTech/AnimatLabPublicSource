...
Public Class XmlDom
    ...
    Protected Overridable Function ReplaceXmlText(ByVal strXml As String, ByVal aryReplaceText As Hashtable) As String
        ...
        Dim oRep As ReplaceText
        For Each de As DictionaryEntry In aryReplaceText
            oRep = DirectCast(de.Value, ReplaceText)
    ...
    Public Overridable Function CopyScaledNumber(ByVal OrigFile As XmlDom, ByVal xnOldNode As XmlNode, ByVal xnNewNode As XmlNode, ByVal strOldNode As String, ByVal strNewNode As String) As XmlNode
