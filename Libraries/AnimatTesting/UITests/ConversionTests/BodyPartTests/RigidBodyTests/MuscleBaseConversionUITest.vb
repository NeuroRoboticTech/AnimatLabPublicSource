...
#Region "Methods"
                    ...
                    Public Overridable Sub MuscleTest()
                        ...
                        AssertErrorDialogShown("The off-page connector node 'OP2' must be associated with another node before you can connect it with a link.", enumErrorTextType.Contains)
