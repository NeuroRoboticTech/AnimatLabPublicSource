...
#Region "Methods"
                    ...
                    Protected Overrides Function GetPhysicsEngine() As Boolean

                        Dim bRet As Boolean = MyBase.GetPhysicsEngine()
                    ...
                    Protected Overrides Sub TestMovableRigidBodyProperties(ByVal strStructure As String, ByVal strPart As String)
                        ...
                        ExecuteIndirectMethod("SetObjectProperty", New Object() {"Simulation\Environment\" & m_strStructureGroup & "\" & strStructure & "\Body Plan\" & strPart, "MajorAxisRadius", "0.04"})
                        ...
                        'Set the major radius to a valid value.
                        ExecuteIndirectMethod("SetObjectProperty", New Object() {"Simulation\Environment\" & m_strStructureGroup & "\" & strStructure & "\Body Plan\" & strPart, "MajorAxisRadius", "0.03"})


                        'Set the minor radius to a valid value.
                        ExecuteIndirectMethod("SetObjectProperty", New Object() {"Simulation\Environment\" & m_strStructureGroup & "\" & strStructure & "\Body Plan\" & strPart, "MinorAxisRadius", "0.02"})
                        ...
                        'Set the minor radius to a valid value.
                        ExecuteIndirectMethod("SetObjectProperty", New Object() {"Simulation\Environment\" & m_strStructureGroup & "\" & strStructure & "\Body Plan\" & strPart, "MinorAxisRadius", "0.01"})
