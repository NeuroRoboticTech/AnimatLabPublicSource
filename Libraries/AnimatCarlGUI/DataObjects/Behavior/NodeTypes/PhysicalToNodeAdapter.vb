...
Namespace DataObjects.Behavior.NodeTypes
    ...
    Public Class PhysicalToNodeAdapter
        Inherits AnimatGUI.DataObjects.Behavior.Nodes.PhysicalToNodeAdapter
...
#Region " Methods "
        ...
        Public Overrides Function Clone(ByVal doParent As AnimatGUI.Framework.DataObject, ByVal bCutData As Boolean, _
            ...
            Dim oNewNode As New PhysicalToNodeAdapter(doParent)
        ...
        Protected Overrides Sub CloneInternal(doOriginal As AnimatGUI.Framework.DataObject, bCutData As Boolean, doRoot As AnimatGUI.Framework.DataObject)
            ...
            Dim doRate As PhysicalToNodeAdapter = DirectCast(doOriginal, PhysicalToNodeAdapter)
        ...
        Protected Overrides Sub SaveSimulationXmlInternal(oXml As ManagedAnimatInterfaces.IStdXml, nmTarget As AnimatGUI.DataObjects.Behavior.NeuralModule, _
                                                          bnOrigin As AnimatGUI.DataObjects.Behavior.Node, bnDestination As AnimatGUI.DataObjects.Behavior.Node, _
                                                          bpPart As AnimatGUI.DataObjects.Behavior.Nodes.BodyPart, Optional ByRef nmParentControl As AnimatGUI.Framework.DataObject = Nothing, _
                                                          Optional strName As String = "")
            MyBase.SaveSimulationXmlInternal(oXml, nmTarget, bnOrigin, bnDestination, bpPart, nmParentControl, strName)
