...
namespace AnimatGuiCtrls.Video {
	...
	public class Avi{
		...
		public static readonly System.UInt32 streamtypeVIDEOU = (System.UInt32) mmioFOURCC('v', 'i', 'd', 's');
...
//
//
//		public static void ShowCodecsDialog1()
//		{
...
//			
//			IntPtr ps = new IntPtr(0);
//			IntPtr *ptr_ps = &x;
//
//			AVISaveOptions(IntPtr.Zero, 0, 1, ref ps, ref p);
//
//
//		}
