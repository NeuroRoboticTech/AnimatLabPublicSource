...
{
    public class AnimatContextMenuStrip : System.Windows.Forms.ContextMenuStrip
    {
        protected string m_strToolName = "";
        protected SecurityManager m_Security = null;

        public AnimatContextMenuStrip()
        {
        }

        public AnimatContextMenuStrip(string strToolName, SecurityManager security)
        {
        ...
        protected bool SecurityExclude(ToolStripItem item)
        {
            ...
            {
                SecurityItem sItem;
                if (m_Security.Menus.TryGetValue(m_strToolName + "." + item.Name, out sItem))
