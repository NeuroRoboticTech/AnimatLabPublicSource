...
namespace AnimatGuiCtrls.Controls
{
	...
	public class PropertySpec
	{
		...
		public PropertySpec(string name, string type, string strPropertyName) : this(name, type, strPropertyName, null, null, null) { }
		...
		/// property grid.</param>
		public PropertySpec(string name, string type, string strPropertyName, string category) : this(name, type, strPropertyName, category, null, null) { }
		...
		public PropertySpec(string name, Type type, string strPropertyName, string category) :
			this(name, type.AssemblyQualifiedName, strPropertyName, category, null, null) { }
		...
		/// property grid.</param>
		public PropertySpec(string name, string type, string strPropertyName, string category, string description) :
			this(name, type, strPropertyName, category, description, null) { }
		...
		/// <param name="description">A string that is displayed in the help area of the
		/// property grid.</param>
		public PropertySpec(string name, Type type, string strPropertyName, string category, string description) :
			this(name, type.AssemblyQualifiedName, strPropertyName, category, description, null) { }
		...
		public PropertySpec(string name, string type, string strPropertyName, string category, string description, object defaultValue)
		{
			this.name = name;
			this.type = type;
		...
		/// <param name="defaultValue">The default value of the property, or null if there is
		/// no default value.</param>
		public PropertySpec(string name, string type, string strPropertyName, string category, string description, object defaultValue, bool bReadonly)
		{
			this.name = name;
			this.type = type;
			this.category = category;
		...
		/// <param name="defaultValue">The default value of the property, or null if there is
		/// no default value.</param>
		public PropertySpec(string name, Type type, string strPropertyName, string category, string description, object defaultValue, bool bReadonly) :
			this(name, type.AssemblyQualifiedName, strPropertyName, category, description, defaultValue, bReadonly) { }
		...
		public PropertySpec(string name, string type, string strPropertyName, string category, string description, object defaultValue,
			string editor) : this(name, type, strPropertyName, category, description, defaultValue)
		{
			this.editor = editor;
		}
		...
		/// converter for this property.  This type must derive from TypeConverter.</param>
		public PropertySpec(string name, string type, string strPropertyName, string category, string description, object defaultValue,
			string editor, string typeConverter) : this(name, type, strPropertyName, category, description, defaultValue)
		{
			this.editor = editor;
		...
		public PropertySpec(string name, Type type, string strPropertyName, string category, string description, object defaultValue,
			...
			this(name, type.AssemblyQualifiedName, strPropertyName, category, description, defaultValue, editor, typeConverter) { }
		...
		public PropertySpec(string name, string type, string strPropertyName, string category, string description, object defaultValue,
			...
			this(name, type, strPropertyName, category, description, defaultValue, editor.AssemblyQualifiedName,
			typeConverter) { }
		...
		/// converter for this property.  This type must derive from TypeConverter.</param>
		public PropertySpec(string name, Type type, string strPropertyName, string category, string description, object defaultValue,
			Type editor, string typeConverter, bool bReadOnly) : 
			this(name, type.AssemblyQualifiedName, strPropertyName, category, description, defaultValue,
			editor.AssemblyQualifiedName, typeConverter) 
		{ 
			this.m_bReadOnly = bReadOnly;
		...
		public PropertySpec(string name, string type, string strPropertyName, string category, string description, object defaultValue,
			...
			this(name, type, strPropertyName, category, description, defaultValue, editor, typeConverter.AssemblyQualifiedName) { }
		...
		/// converter for this property.  This type must derive from TypeConverter.</param>
		public PropertySpec(string name, string type, string strPropertyName, string category, string description, object defaultValue,
			string editor, Type typeConverter, bool bReadOnly) :
			this(name, type, strPropertyName, category, description, defaultValue, editor, typeConverter.AssemblyQualifiedName) 
		{ 
			this.m_bReadOnly = bReadOnly;
		}
		...
		public PropertySpec(string name, Type type, string strPropertyName, string category, string description, object defaultValue,
			string editor, Type typeConverter) :
			this(name, type.AssemblyQualifiedName, strPropertyName, category, description, defaultValue, editor,
		...
		/// <summary>
		/// Gets or sets the name of the this property.
		/// </summary>
	...
	public class PropertyBag : ICustomTypeDescriptor
	{
		...
		public class PropertySpecCollection : IList
		{
			...
			protected PropertyBag m_Parent;
            ...
            protected void AddSecurityRange(PropertySpec[] array)
            {
                int iCount = array.GetLength(0);
			...
			public void Remove(string name)
			{
				...
				if(index<0)
					throw new System.Exception("No propertyspec object with the name '" + name + "' was found in the property bag.");
				RemoveAt(index);
			}
        ...
        protected SecurityManager m_Security;
		...
		/// <summary>
		/// A user defined value that can be attached to this property bag.
		/// </summary>
		public Object Tag
		{
			get { return m_oTag; }
...
//				throw new System.Exception("No value with the specified property name exists. PropertyName: " + e.Property.Name);
	...
	public class ExpandablePropBagConverter : ExpandableObjectConverter 
	{
		...
		{
			if (destinationType == typeof(PropertyBag)) 
				return true;
