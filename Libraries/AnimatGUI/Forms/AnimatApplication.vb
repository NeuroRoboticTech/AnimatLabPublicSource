...
#Region " Project Creation "
        ...
        Public Overridable Sub CompareExportedDataCharts(ByVal strPrefix As String, ByVal strTemplatePath As String, ByVal dblMaxError As Double, ByVal iMaxRows As Integer)
            ...
            For Each frmAnimat As AnimatForm In Me.ChildForms
                ...
                If Util.IsTypeOf(frmAnimat.GetType(), GetType(Tools.DataChart), False) Then
                    frmChart = DirectCast(frmAnimat, Tools.DataChart)
                    frmChart.CompareExportedData(strPrefix, strTemplatePath, dblMaxError, iMaxRows)
                End If
            Next
