...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            '
            Me.ViewToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.RunSimulationToolStripMenuItem, Me.ToolStripSeparator3, Me.CustomizeToolStripMenuItem, Me.PreferencesToolStripMenuItem})
            ...
            Me.AnimatToolStrip.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.NewToolStripButton, Me.OpenToolStripButton, Me.SaveToolStripButton, Me.toolStripSeparator1, Me.HelpToolStripButton, Me.ToolStripSeparator5, Me.AddOrganismStripButton, Me.AddStructureToolStripButton, Me.AddToolToolStripButton, Me.DeleteToolStripButton})
            ...
            Me.AnimatToolStrip.Size = New System.Drawing.Size(208, 25)
...
#Region " Attributes "
        ...
        Protected m_mgrToolStripImages As AnimatTools.Framework.ImageManager
        Protected m_mgrLargeImages As AnimatTools.Framework.ImageManager
        Protected m_mgrWorkspaceImages As AnimatTools.Framework.ImageManager
        Protected m_mgrTabPagesImages As AnimatTools.Framework.ImageManager
        ...
        Protected m_strPhysicsAssemblyName As String = "AnimatTools.dll"
        Protected m_strPhysicsClassName As String = "AnimatTools.DataObjects.Simulation"
        Protected m_strSimulationFile As String = ""
        Protected m_strLogDirectory As String = ""

        Protected m_strBodyEditorDll As String = "AnimatTools.dll"
        Protected m_strBodyEditorNamespace As String = "AnimatTools"
        ...
        Protected m_doSimInterface As New AnimatTools.Interfaces.SimulatorInterface
...
#End Region
        ...
        Public Overridable ReadOnly Property ToolStripImages() As AnimatTools.Framework.ImageManager
            Get
        ...
        Public Overridable ReadOnly Property TabPagesImages() As AnimatTools.Framework.ImageManager
            Get
                Return m_mgrTabPagesImages
            End Get
        End Property

        Public Overridable ReadOnly Property WorkspaceImages() As AnimatTools.Framework.ImageManager
            Get
        ...
        Public Overridable ReadOnly Property SimulationInterface() As AnimatTools.Interfaces.SimulatorInterface
            Get
...
#Region " Initialization "
        ...
        Public Overrides Sub Initialize(Optional ByVal frmParent As AnimatForm = Nothing)
            ...
            Try
                ...
                Me.AnimatToolStrip.ToolName = "AnimatTools.Forms.AnimatApplication"
                Me.AnimatToolStrip.SecurityMgr = Me.SecurityMgr

                Me.AnimatMenuStrip.ToolName = "AnimatTools.Forms.AnimatApplication"
...
#Region " Menu/Toolbar Creation "
        ...
        Protected Overridable Sub CreateImageManager()
            ...
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.Open_Toolbar.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.Save_Toolbar.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.NewProject.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.ProjectWorkspace.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.ProjectProperties.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.Simulate.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.SimulationController.gif")
            ...
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.HelpContents.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.HelpSearch.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.TechnicalSupport.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.ExportStandalone.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.CutFromWorkspace.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.AddDataTool.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.AddOrganism.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.AddStructure.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.AddGround.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.AddWater.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.Expand.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.Collapse.gif")
            ...
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.preference.gif")
            m_mgrToolStripImages.AddImage(myAssembly, "AnimatTools.Swap.gif")

            Me.Icon = m_mgrToolStripImages.LoadIcon(myAssembly, "AnimatTools.Crayfish.ico")

            m_mgrWorkspaceImages = New AnimatTools.Framework.ImageManager
            m_mgrTabPagesImages = New AnimatTools.Framework.ImageManager
        ...
        '    '             m_mgrToolStripImages.GetImageIndex("AnimatTools.NewProject.gif"), Shortcut.CtrlN, _
        ...
        '    '             m_mgrToolStripImages.GetImageIndex("AnimatTools.Open_Toolbar.gif"), Shortcut.CtrlO, _
        ...
        '    '             m_mgrToolStripImages.GetImageIndex("AnimatTools.Save_Toolbar.gif"), Shortcut.CtrlS, _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.ExportStandalone.gif"), New EventHandler(AddressOf Me.OnExportStandaloneSim))
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.Undo.gif"), _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.Redo.gif"), _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.CutFromWorkspace.gif"), _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.AddOrganism.gif"), _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.AddStructure.gif"), _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.AddGround.gif"), _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.AddWater.gif"), _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.AddDataTool.gif"), _
        ...
        '    '                          m_mgrToolStripImages.GetImageIndex("AnimatTools.preference.gif"), _
        ...
        '    '             m_mgrToolStripImages.GetImageIndex("AnimatTools.Simulate.gif"), Shortcut.F5, _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.HelpContents.gif"), _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.HelpSearch.gif"), _
        ...
        '    '                                      m_mgrToolStripImages.GetImageIndex("AnimatTools.TechnicalSupport.gif"), New EventHandler(AddressOf Me.OnTechnicalSupport))
...
#Region " Project Creation "
        ...
        Public Overridable Sub ResetProject(ByVal bNewProject As Boolean)
            ...
            If bNewProject Then
                ...
                afForm = CreateDockingForm(m_dockManager, "AnimatTools.dll", _
                                  "AnimatTools.Forms.ProjectProperties", _
        ...
        Public Overridable Sub CloseProject(ByVal bOpeningProject As Boolean)
            ...
            m_strPhysicsAssemblyName = "AnimatTools.dll"
            m_strPhysicsClassName = "AnimatTools.DataObjects.Simulation"
            'm_doSimulation = DirectCast(Util.LoadClass(m_strPhysicsAssemblyName, m_strPhysicsClassName, Me.FormHelper), AnimatTools.DataObjects.Simulation)
        ...
        Public Overridable Function SaveStandAlone(ByVal bSaveCharts As Boolean, ByVal bSaveStims As Boolean, ByVal bSaveChartsToFile As Boolean) As AnimatTools.Interfaces.StdXml
...
#Region " Load/Save Methods "
        ...
        Public Overridable Sub LoadDockingForm(ByRef dockManager As DockingManager, _
            ...
            Try
                ...
                ElseIf strClass = "AnimatTools.Forms.ProjectProperties" Then
...
#Region " Windows Management "
        ...
        Public Overridable Sub EditBodyPlan(ByVal doStructure As DataObjects.Physical.PhysicalStructure)
            ...
            Try
                ...
                Dim frmAnimat As Forms.BodyPlan.Editor = DirectCast(CreateForm("AnimatTools.dll", "AnimatTools.Forms.BodyPlan.Editor", doStructure.Name & " Body", False), Forms.BodyPlan.Editor)
        ...
        Public Overridable Function EditEnvironment() As AnimatTools.Forms.MdiChild
...
#Region " Event Handlers "
        ...
        Protected Overridable Sub OnCreateSimulation(ByRef strXml As String)
            Dim oXml As AnimatTools.Interfaces.StdXml = Util.Application.SaveStandAlone(False, False, False)
...
#Region " Seleciton and Display Mode Event Handlers "
        ...
        Private Sub SelGraphicsToolStripButton_CheckStateChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SelGraphicsToolStripButton.CheckStateChanged
            If SelGraphicsToolStripButton.Checked Then
                SelCollisionToolStripButton.Checked = False
                SelJointsToolStripButton.Checked = False
                SelRecFieldsToolStripButton.Checked = False
            End If
            Util.Simulation.VisualSelectionMode = Simulation.enumVisualSelectionMode.SelectGraphics
        End Sub

        Private Sub SelCollisionToolStripButton_CheckStateChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SelCollisionToolStripButton.CheckStateChanged
            If SelCollisionToolStripButton.Checked Then
                SelGraphicsToolStripButton.Checked = False
                SelJointsToolStripButton.Checked = False
                SelRecFieldsToolStripButton.Checked = False
            End If
        ...
        Private Sub SelJointsToolStripButton_CheckStateChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SelJointsToolStripButton.CheckStateChanged
            If SelJointsToolStripButton.Checked Then
                SelGraphicsToolStripButton.Checked = False
                SelCollisionToolStripButton.Checked = False
                SelRecFieldsToolStripButton.Checked = False
            End If
            Util.Simulation.VisualSelectionMode = Simulation.enumVisualSelectionMode.SelectJoints
        End Sub

        Private Sub SelRecFieldsToolStripButton_CheckStateChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SelRecFieldsToolStripButton.CheckStateChanged
            If SelRecFieldsToolStripButton.Checked Then
                SelGraphicsToolStripButton.Checked = False
                SelCollisionToolStripButton.Checked = False
                SelJointsToolStripButton.Checked = False
            End If
            Util.Simulation.VisualSelectionMode = Simulation.enumVisualSelectionMode.SelectReceptiveFields
        End Sub
