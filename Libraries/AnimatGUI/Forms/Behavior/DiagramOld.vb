...
Namespace Forms.Behavior
    ...
    Public MustInherit Class DiagramOld
        Inherits AnimatForm
...
#Region " Attributes "
        ...
        Protected m_bnParentDiagram As AnimatGUI.Forms.Behavior.DiagramOld
...
#Region " Properties "
        ...
        Public Overridable Property ParentDiagram() As Behavior.DiagramOld
            Get
                Return m_bnParentDiagram
            End Get
            Set(ByVal Value As Behavior.DiagramOld)
...
#Region " Methods "
        ...
        Public Overridable Function AddDiagram(ByVal strAssemblyName As String, ByVal strClassName As String, _
            ...
            Dim bdDiagram As Forms.Behavior.DiagramOld = m_beEditor.CreateDiagram(strAssemblyName, strClassName, Me, strPageName)
        ...
        Public Overridable Function AddDiagram(ByVal bdDiagram As Forms.Behavior.DiagramOld) As Behavior.DiagramOld
        ...
        Public Overridable Sub RestoringDiagram()
            ...
            Dim bdChild As Forms.Behavior.DiagramOld
            For Each deEntry As DictionaryEntry In m_aryDeletedDiagrams
                bdChild = DirectCast(deEntry.Value, Forms.Behavior.DiagramOld)
        ...
        Public Overridable Sub RestoreDiagram(ByVal bdDiagram As Behavior.DiagramOld)
        ...
        Public Overridable Function FindDiagram(ByVal strID As String) As Forms.Behavior.DiagramOld
        ...
        Public Overridable Function FindDiagramByName(ByVal strName As String) As Forms.Behavior.DiagramOld
