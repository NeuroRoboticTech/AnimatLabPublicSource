...
#Region "Rigid Body Part Type Modifiers"
            ...
            Protected Overridable Sub ModifyRigidBodyMesh(ByVal xnRigidBody As XmlNode, ByVal aryParentTrasform As AnimatGuiCtrls.MatrixLibrary.Matrix, _
                ...
                Dim strBaseColliosionMeshName As String = strMeshFileOld.Replace("." & strExt, "")
                ...
                Dim strCollisionNewMeshBase As String = EnsureUniqueMeshName(strBaseColliosionMeshName)
                Dim strCollisionMeshFile As String = strCollisionNewMeshBase & ".osg"
                ...
                If strCollisionMeshType.ToUpper() = "CONVEX" Then
                    strExt = Util.GetFileExtension(strCollisionMeshFileOld)
                    Dim strConvexMeshFile As String = strCollisionNewMeshBase & "_Convex.osg"
