...
#Region " Methods "
        ...
        Public Sub New(ByVal doParent As Framework.DataObject)
            ...
            m_snFrictionSecondary = New AnimatGUI.Framework.ScaledNumber(Me, "FrictionSecondary", 0.2, AnimatGUI.Framework.ScaledNumber.enumNumericScale.None)
            m_snMaxFrictionPrimary = New AnimatGUI.Framework.ScaledNumber(Me, "MaxFrictionPrimary", 10, ScaledNumber.enumNumericScale.None, "Newtons", "N")
            m_snMaxFrictionSecondary = New AnimatGUI.Framework.ScaledNumber(Me, "MaxSecondaryFriction", 10, ScaledNumber.enumNumericScale.None, "Newtons", "N")
            ...
            m_snSlipPrimary = New AnimatGUI.Framework.ScaledNumber(Me, "PrimarySlip", 0.2, AnimatGUI.Framework.ScaledNumber.enumNumericScale.None, "s/Kg", "s/Kg")
            m_snSlipSecondary = New AnimatGUI.Framework.ScaledNumber(Me, "SecondarySlip", 0.2, AnimatGUI.Framework.ScaledNumber.enumNumericScale.None, "s/Kg", "s/Kg")
        ...
        Protected Overrides Sub CloneInternal(ByVal doOriginal As AnimatGUI.Framework.DataObject, ByVal bCutData As Boolean, _
            ...
            m_snFrictionPrimary = DirectCast(doOrig.m_snFrictionPrimary.Clone(Me, bCutData, doRoot), AnimatGUI.Framework.ScaledNumber)
            m_snFrictionSecondary = DirectCast(doOrig.m_snFrictionSecondary.Clone(Me, bCutData, doRoot), AnimatGUI.Framework.ScaledNumber)
            m_snMaxFrictionPrimary = DirectCast(doOrig.m_snMaxFrictionPrimary.Clone(Me, bCutData, doRoot), AnimatGUI.Framework.ScaledNumber)
            m_snMaxFrictionSecondary = DirectCast(doOrig.m_snMaxFrictionSecondary.Clone(Me, bCutData, doRoot), AnimatGUI.Framework.ScaledNumber)
            ...
            m_snSlipPrimary = DirectCast(doOrig.m_snSlipPrimary.Clone(Me, bCutData, doRoot), AnimatGUI.Framework.ScaledNumber)
            m_snSlipSecondary = DirectCast(doOrig.m_snSlipSecondary.Clone(Me, bCutData, doRoot), AnimatGUI.Framework.ScaledNumber)
            m_snSlidePrimary = DirectCast(doOrig.m_snSlidePrimary.Clone(Me, bCutData, doRoot), AnimatGUI.Framework.ScaledNumber)
            m_snSlideSecondary = DirectCast(doOrig.m_snSlideSecondary.Clone(Me, bCutData, doRoot), AnimatGUI.Framework.ScaledNumber)
...
#Region " Add-Remove to List Methods "
        ...
        Public Overrides Sub AddToSim(ByVal bThrowError As Boolean, Optional ByVal bDoNotInit As Boolean = False)
            If m_doInterface Is Nothing AndAlso Not Util.Simulation Is Nothing Then
                Util.Application.SimulationInterface.AddItem(Util.Simulation.ID, "MaterialPair", Me.ID, Me.GetSimulationXml("MaterialPair"), bThrowError, bDoNotInit)
