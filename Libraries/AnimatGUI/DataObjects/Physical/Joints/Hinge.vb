...
#End Region
        ...
        Public Sub New(ByVal doParent As Framework.DataObject)
            ...
            m_doRelaxation3 = New ConstraintRelaxation(Me, "Third Axis Displacement", "Sets the relaxation for the displacement rotation axis.", ConstraintRelaxation.enumCoordinateID.Relaxation3)
