...
#Region " Methods "
        ...
        Public Sub New()
            ...
            m_thDataTypes.DataTypes.Add(New AnimatGUI.DataObjects.DataType("TotalMicroSleepTime", "MicroSleep Time", "Seconds", "s", 0, 1))
            m_thDataTypes.DataTypes.Add(New AnimatGUI.DataObjects.DataType("TotalMicroSleepCount", "MicroSleep Count", "", "", 0, 1))
            m_thDataTypes.DataTypes.Add(New AnimatGUI.DataObjects.DataType("TotalMicroWaitTime", "MicroWait Time", "Seconds", "s", 0, 1))
            m_thDataTypes.DataTypes.Add(New AnimatGUI.DataObjects.DataType("TotalMicroWaitCount", "MicroWait Count", "", "", 0, 1))
