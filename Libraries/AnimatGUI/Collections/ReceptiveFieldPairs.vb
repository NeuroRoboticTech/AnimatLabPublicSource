...
Namespace Collections
    ...
    Public Class SortedReceptiveFieldPairs
        ...
        Public Overloads Sub Add(ByVal key As [String], ByVal value As AnimatGUI.DataObjects.Physical.ReceptiveFieldPair, Optional ByVal bCallAddMethods As Boolean = True, Optional ByVal bThrowError As Boolean = True)
