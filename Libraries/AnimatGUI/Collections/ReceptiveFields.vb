...
Namespace Collections
    ...
    Public Class SortedReceptiveFields
        ...
        Public Overloads Sub Add(ByVal key As [String], ByVal value As AnimatGUI.DataObjects.Physical.ReceptiveField, Optional ByVal bCallSimMethods As Boolean = True, Optional ByVal bThrowError As Boolean = True)
