...
Namespace Collections
    ...
    Public Class SortedHudItems
        ...
        Public Overloads Sub Add(ByVal key As [String], ByVal value As AnimatGUI.DataObjects.Visualization.HudItem, Optional ByVal bCallAddMethods As Boolean = True, Optional ByVal bThrowError As Boolean = True)
