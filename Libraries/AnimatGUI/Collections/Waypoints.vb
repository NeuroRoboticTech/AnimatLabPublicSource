...
Namespace Collections
    ...
    Public Class Waypoints
        ...
        Default Public Property Item(ByVal index As Integer) As AnimatGUI.DataObjects.Visualization.Waypoint
            Get
                Return CType(List(index), AnimatGUI.DataObjects.Visualization.Waypoint)
            End Get
        ...
        Public Function Add(ByVal value As AnimatGUI.DataObjects.Visualization.Waypoint) As Integer
            Me.IsDirty = True
            Return List.Add(value)
        End Function 'Add

        Public Function IndexOf(ByVal value As AnimatGUI.DataObjects.Visualization.Waypoint) As Integer
            Return List.IndexOf(DirectCast(value, AnimatGUI.DataObjects.Visualization.Waypoint))
        End Function 'IndexOf


        Public Sub Insert(ByVal index As Integer, ByVal value As AnimatGUI.DataObjects.Visualization.Waypoint)
            Me.IsDirty = True
            List.Insert(index, value)
        End Sub 'Insert


        Public Sub Remove(ByVal value As AnimatGUI.DataObjects.Visualization.Waypoint)
            Me.IsDirty = True
            List.Remove(value)
        End Sub 'Remove


        Public Function Contains(ByVal value As AnimatGUI.DataObjects.Visualization.Waypoint) As Boolean
        ...
        Protected Overrides Sub OnInsert(ByVal index As Integer, ByVal value As [Object])
            If Not TypeOf (value) Is AnimatGUI.DataObjects.Visualization.Waypoint Then
                Throw New ArgumentException("value must be of type AnimatGUI.DataObjects.Visualization.Waypoint.", "value")
            End If
        End Sub 'OnInsert
        ...
        Protected Overrides Sub OnSet(ByVal index As Integer, ByVal oldValue As [Object], ByVal newValue As [Object])
            If Not TypeOf (newValue) Is AnimatGUI.DataObjects.Visualization.Waypoint Then
                Throw New ArgumentException("newValue must be of type AnimatGUI.DataObjects.Visualization.Waypoint.", "newValue")
            End If
        End Sub 'OnSet
        ...
        Protected Overrides Sub OnValidate(ByVal value As [Object])
            If Not TypeOf (value) Is AnimatGUI.DataObjects.Visualization.Waypoint Then
                Throw New ArgumentException("value must be of type AnimatGUI.DataObjects.Visualization.Waypoint.")
            End If
        End Sub 'OnValidate 

        Public Overrides Function Copy() As AnimatCollectionBase
            Dim aryList As New Waypoints(m_doParent)
        ...
        Public Overrides Function Clone(ByVal doParent As AnimatGUI.Framework.DataObject, ByVal bCutData As Boolean, _
            ...
            Dim aryList As New Waypoints(doParent)
    ...
    Public Class SortedWaypoints
        ...
        Protected Overrides Sub OnInsert(ByVal key As [Object], ByVal value As [Object])
            ...
            Dim diImage As AnimatGUI.DataObjects.Visualization.Waypoint = DirectCast(value, AnimatGUI.DataObjects.Visualization.Waypoint)
        ...
        Public Overrides Function Copy() As AnimatDictionaryBase
            Dim aryList As New SortedWaypoints(m_doParent)
            aryList.CopyInternal(Me)
            Return aryList
        End Function
        ...
        Public Overrides Function Clone(ByVal doParent As AnimatGUI.Framework.DataObject, ByVal bCutData As Boolean, _
            ...
            Dim aryList As New SortedWaypoints(doParent)
            aryList.CloneInternal(Me, doParent, bCutData, doRoot)
            Return aryList
        End Function
