...
Namespace Collections
    ...
    Public Class SortedAttachmentList
        ...
        Public Overloads Sub Add(ByVal key As [String], ByVal value As AnimatGUI.DataObjects.Physical.Bodies.Attachment, Optional ByVal bCallSimMethods As Boolean = True, Optional ByVal bThrowError As Boolean = True)
