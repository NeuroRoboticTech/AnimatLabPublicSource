...
namespace AnimatSim
{
	namespace Environment
	{
		...
		public:
			...
			virtual void Physics_CollectBodyData(Simulator *lpSim) = 0;
			virtual void Physics_ResetSimulation(Simulator *lpSim, Structure *lpStructure) = 0;
			...
			virtual void Physics_EnableCollision(Simulator *lpSim, RigidBody *lpBody) = 0;
			virtual void Physics_DisableCollision(Simulator *lpSim, RigidBody *lpBody) = 0;
			virtual void Physics_AddBodyForce(Simulator *lpSim, float fltPx, float fltPy, float fltPz, float fltFx, float fltFy, float fltFz, BOOL bScaleUnits) = 0;
			virtual void Physics_AddBodyTorque(Simulator *lpSim, float fltTx, float fltTy, float fltTz, BOOL bScaleUnits) = 0;
