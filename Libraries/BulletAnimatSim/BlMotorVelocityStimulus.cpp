/**
\file	BlMotorVelocityStimulus.cpp
...
\date	4/3/2011
**/
BlMotorVelocityStimulus::BlMotorVelocityStimulus()
{
	m_lpJoint = NULL;
	m_lpEval = NULL;
	m_fltVelocity = 0;
...
{Std_TraceMsg(0, "Caught Error in desctructor of BlMotorVelocityStimulus\r\n", "", -1, false, true);}
}
...
**/
void BlMotorVelocityStimulus::VelocityEquation(string strVal)
{
...
void BlMotorVelocityStimulus::ResetSimulation()
{
...
void BlMotorVelocityStimulus::Initialize()
{
...
void BlMotorVelocityStimulus::Activate()
{
...
void BlMotorVelocityStimulus::StepSimulation()
{
	//float fltVel=0;
...
void BlMotorVelocityStimulus::Deactivate()
{
...
float *BlMotorVelocityStimulus::GetDataPointer(const string &strDataType)
{
	float *lpData=NULL;
...
bool BlMotorVelocityStimulus::SetData(const string &strDataType, const string &strValue, bool bThrowError)
{
	string strType = Std_CheckString(strDataType);
...
void BlMotorVelocityStimulus::QueryProperties(CStdArray<string> &aryNames, CStdArray<string> &aryTypes)
{
...
void BlMotorVelocityStimulus::Load(CStdXml &oXml)
{
