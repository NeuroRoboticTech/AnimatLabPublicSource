...
VsAutoTransform::VsAutoTransform() :
...
VsAutoTransform::VsAutoTransform(const VsAutoTransform& pat,const CopyOp& copyop):
...
void VsAutoTransform::setScale(const Vec3d& scale)
{
    _scale = scale; 
...
bool VsAutoTransform::computeLocalToWorldMatrix(Matrix& matrix,NodeVisitor*) const
{
...
bool VsAutoTransform::computeWorldToLocalMatrix(Matrix& matrix,NodeVisitor*) const
{
...
void VsAutoTransform::computeMatrix() const
{
...
void VsAutoTransform::accept(NodeVisitor& nv)
{
...
BoundingSphere VsAutoTransform::computeBound() const
{
