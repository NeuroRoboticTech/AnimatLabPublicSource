/**
\file	CsIntegrateNeuron.h

\brief	Declares the CsIntegrateNeuron class.
**/
...
namespace AnimatCarlSim
{
	...
	\date	3/29/2011
	**/
	class ANIMAT_CARL_SIM_PORT CsIntegrateNeuron : public AnimatSim::Node 
	{
	protected:
