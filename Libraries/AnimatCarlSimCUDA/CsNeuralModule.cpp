...
//**/
//bool CsNeuralModule::ActiveArray()
...
//**/
//void CsNeuralModule::ActiveArray(bool bVal)
//{
//	m_bActiveArray = bVal;
//}
//
...
//\return	true for array element 1, false for array element 0.
//**/
//bool CsNeuralModule::InactiveArray()
//{return !m_bActiveArray;}
//
///**
...
//\param	bVal	true for array element 1, false for array element 0.
//**/
//void CsNeuralModule::InactiveArray(bool bVal)
//{
//	m_bActiveArray = !bVal;
//}
//
...
//#pragma endregion
//
//long CsNeuralModule::CalculateSnapshotByteSize()
//{
//	long lByteSize = 0;
//	int iCount = m_aryNeurons.GetSize();
//	for(int iIndex=0; iIndex<iCount; iIndex++)
...
//}
//
//void CsNeuralModule::SaveKeyFrameSnapshot(byte *aryBytes, long &lIndex)
//{
//	int iCount = m_aryNeurons.GetSize();
//	for(int iIndex=0; iIndex<iCount; iIndex++)
//		if(m_aryNeurons[iIndex])
...
//}
//
//void CsNeuralModule::LoadKeyFrameSnapshot(byte *aryBytes, long &lIndex)
//{
//	int iCount = m_aryNeurons.GetSize();
//	for(int iIndex=0; iIndex<iCount; iIndex++)
//		if(m_aryNeurons[iIndex])
...
//**/
//Neuron *CsNeuralModule::LoadNeuron(CStdXml &oXml)
//{
