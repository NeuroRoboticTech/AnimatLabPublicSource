...
Namespace DataObjects.Physical.RigidBodies
    ...
    Public Class [*MUSCLE_NAME*]
        Inherits VortexAnimatTools.DataObjects.Physical.RigidBodies.MuscleBase
...
#Region " Properties "
        ...
        Public Overrides ReadOnly Property PartType() As System.Type
            Get
                Return GetType([*PROJECT_NAME*]Tools.DataObjects.Physical.RigidBodies.[*MUSCLE_NAME*])
            End Get
        End Property
...
#Region " Methods "
        ...
        Public Overrides Function Clone(ByVal doParent As AnimatTools.Framework.DataObject, ByVal bCutData As Boolean, _
            ...
            Dim oNewNode As New Physical.RigidBodies.[*MUSCLE_NAME*](doParent)
        ...
        Protected Overrides Sub CloneInternal(ByVal doOriginal As AnimatTools.Framework.DataObject, ByVal bCutData As Boolean, _
            ...
            Dim bnOrig As Physical.RigidBodies.[*MUSCLE_NAME*] = DirectCast(doOriginal, Physical.RigidBodies.[*MUSCLE_NAME*])
