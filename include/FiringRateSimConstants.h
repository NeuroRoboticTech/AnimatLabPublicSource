...
#define Nl_Err_lSynapseNotFound -3032
#define Nl_Err_strSynapseNotFound "The specified synapse was not found."


//Max-Min Values
#define MAX_CHEMICAL_SENSORS 5

//Neuron Types
#define NO_NEURON 0
#define RUGULAR_NEURON 1
#define PACEMAKER_NEURON 2
#define TONIC_NEURON 3
#define RANDOM_NEURON 4
#define BISTABLE_NEURON 5

//Synapse Types
#define REGULAR_SYNAPSE 0
#define GATED_SYNAPSE 1
#define MODULATED_SYNAPSE 2
#define COMPOUND_SYNAPSE 3

//PaceMaker Neuron Current Types
#define NO_CURRENT 0
#define IH_CURRENT 1
#define IL_CURRENT 2

////Data Types
#define SYNAPSE_WEIGHT_DATA 5
#define SYNAPSE_COMPOUND_WEIGHT_DATA 6
#define SYNAPSE_COMPOUND_MODULATION_DATA 7

//Graph Types
#define LINEAR_GRAPH 0
#define BELL_GRAPH 1
#define SIGMOID_GRAPH 2
#define INVERSE_GRAPH 3
#define QUADRATIC_GRAPH 4
