echo "Generating AnimatSimulator CodeBlocks Solution"
...
TIMEOUT /T 2
..\..\..\bin\fart *.cbp "C:/Projects/AnimatLabSDK/AnimatLabPublicSource/Libraries/BulletAnimatSim" "../../../Libraries/BulletAnimatSim"
TIMEOUT /T 2
