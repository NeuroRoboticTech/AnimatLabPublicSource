...
Public Class Server
    ...
    Public Function ExecuteIndirectMethod(ByVal strMethodName As String, ByVal aryParams() As Object) As Object
        Dim oMethod As MethodInfo = m_doApp.GetType().GetMethod("ExecuteIndirectMethod")
